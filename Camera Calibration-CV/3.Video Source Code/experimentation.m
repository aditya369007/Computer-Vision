%%This has been done for the sake of exploration and experimentation %%
...
v = VideoWriter('Cube2.mp4');
v.FrameRate = 30;
open(v);

for i = 9:-0.1:0
    
    [cube_1_x,cube_1_y] = cameracalib(4,4,0+i);
[cube_2_x,cube_2_y] = cameracalib(5,4,0+i);
[cube_3_x,cube_3_y] = cameracalib(4,5,0+i);
[cube_4_x,cube_4_y] = cameracalib(5,5,0+i);
[cube_5_x,cube_5_y] = cameracalib(4,4,1+i);
[cube_6_x,cube_6_y] = cameracalib(5,4,1+i);
[cube_7_x,cube_7_y] = cameracalib(4,5,1+i);
[cube_8_x,cube_8_y] = cameracalib(5,5,1+i);


% [confetti1_x2,confetti1_y2] = cameracalib(2,7,3);
% [confetti1_x3,confetti1_y3] = cameracalib(1,8,5);
% [confetti1_x4,confetti1_y4] = cameracalib(0,10,9);
...
for i = 1:0.1:9
    [confetti1_x1,confetti1_y1] = cameracalib((4-i),(5+i),(1+(i/2)));
    [confetti2_x1,confetti2_y1] = cameracalib((3-i),(3-i),(1+(i/3)));
    [confetti3_x1,confetti3_y1] = cameracalib((5+i),(4-i),(1*(i)));
    [confetti4_x1,confetti4_y1] = cameracalib((6+i),(6+i),(1*(i/2)));
    [confetti5_x1,confetti5_y1] = cameracalib((randi([ceil(i),10],1)),(randi([ceil(i),10],1)),(1*(i)));
...
hold on;
plot([confetti1_x1],[confetti1_y1],'Marker','*','Color','g');
plot([confetti2_x1],[confetti2_y1],'Marker','*','Color','b');
plot([confetti3_x1],[confetti3_y1],'Marker','>','Color','r');
plot([confetti4_x1],[confetti4_y1],'Marker','diamond','Color','m');
plot([confetti5_x1],[confetti5_y1],'Marker','<','Color','k');
saveas(h,sprintf('disconew1.png'))
G = imread('disconew1.png');
writeVideo(v,G);
end
close(v);
