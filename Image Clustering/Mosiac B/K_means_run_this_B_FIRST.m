...
map_img = imread('mapB.bmp');

v = VideoWriter('Kmeans_animate_5_B.avi'); %output vid file name
...
%mosaic b
centroid{1} = fv_pixel_master(31810,:);
centroid{2} = fv_pixel_master(52448,:);
centroid{3} = fv_pixel_master(62729,:);
